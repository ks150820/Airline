...
public class AirIndia_confirmation {
	JFrame f;
	...
	public void confirmation(String FIRSTNAME,String LASTNAME,String fromText,String toText,String airlinename) throws IOException {
		f=new JFrame("Air-India Airline - Make your trip easy");
		...
		String path="./images/airindiaplane2.png";
